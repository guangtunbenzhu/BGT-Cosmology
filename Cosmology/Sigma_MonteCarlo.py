...
plt.text(13.0, 1.52, r'green: 1-halo gas-to-mass ratio', color='g', fontsize=16)
plt.text(13.0, 1.33, r'orange: 2-halo gas-to-mass ratio', color='#FF8C00', fontsize=16)
plt.text(11.14, -1.25, r'gray band: mass constraint from galaxy-mass correlation', color='0.3', fontsize=13)
plt.text(11.14, -1.4, r'blue band: gas-to-mass ratio constraint from galaxy-gas/mass correlation', color='blue', fontsize=13)
