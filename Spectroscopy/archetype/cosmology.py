...
Some are in Physical frame and others are in Comoving frame. Be careful.
"""
...
def comoving_distance(z, CosPar=_CosPar):
...
luminosity_distance = lambda z, CosPar=_CosPar: comoving_distance(z, CosPar)*(1.+z)
angdiameter_distance = lambda z, CosPar=_CosPar: comoving_distance(z, CosPar)/(1.+z)
